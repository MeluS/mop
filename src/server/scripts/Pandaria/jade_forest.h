...
enum eEvents
{
    ...
    EVENT_DESPAWN                   = 58,
    EVENT_DEVASTATING_ARC           = 59,
    EVENT_SUMMON_QUILEN             = 60,
    EVENT_TITANIC_STRENGTH          = 61,
    EVENT_BELLOWING_RAGE            = 62,
    EVENT_EMPOWERING_FLAMES         = 63,
    EVENT_HOOF_STOMP                = 64,    
    EVENT_RUSHING_CHARGE            = 65,
    EVENT_RAIN_DANCE                = 66,
    EVENT_TORRENT                   = 67,
    EVENT_WATER_BOLT                = 68,
    EVENT_GRAPPLING_HOOK            = 69,
    EVENT_VANISH                    = 70,
    EVENT_VICIOUS_REND              = 71,
    EVENT_SMOKED_BLADE              = 72,
    EVENT_CHI_BURST                 = 73,
    EVENT_HEALING_MIST              = 74,
    EVENT_SPINNING_CRANE_KICK       = 75
};
